...
namespace MainProject
{
    public class SQLprocedure
    {
        ...
        public static List<User> GetRequestsSent(int id)
        {
            List<int> targetIds = new List<int>();
            List<User> target = new List<User>();
            SqlCommand cmd = new SqlCommand("SelectFriendRequestsSent", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter parameter = new SqlParameter("@User_Id", SqlDbType.Int);
            parameter.Value = id;
            ...
            while (result.Read())
            {
                targetIds.Add(result.GetInt32(1));
            }
            result.Close();
            Conn.Close();
            foreach (int userId in targetIds)
            {
                target.Add(GetUser(userId));
            }
            return target;
        }

        public static List<User> GetRequestsTaken(int id)
        {
            List<int> targetIds = new List<int>();
            List<User> target = new List<User>();
            SqlCommand cmd = new SqlCommand("SelectFriendRequestsTaken", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter parameter = new SqlParameter("@User_Id", SqlDbType.Int);
            parameter.Value = id;
            ...
            while (result.Read())
            {
                targetIds.Add(result.GetInt32(0));
            }
            result.Close();
            Conn.Close();
            foreach (int userId in targetIds)
        ...
        public static void CancelSentFriendRequest(int id, int targetId)
        {
            SqlCommand cmd = new SqlCommand("CancelSentFriendRequest", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter[] parameters = new SqlParameter[2];
            parameters[0] = new SqlParameter("@User_Id", SqlDbType.Int);
            parameters[0].Value = id;
            parameters[1] = new SqlParameter("@Target_Id", SqlDbType.Int);
        ...
        public static void AddFriend(int firstId, int secondId)
        {
            SqlCommand cmd = new SqlCommand("AddFriend", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter[] parameters = new SqlParameter[2];
            parameters[0] = new SqlParameter("@first_Id", SqlDbType.Int);
        ...
        public static bool CheckRequest(int firstId, int secondId)
        {
            SqlCommand cmd = new SqlCommand("CheckRequestExistence", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter[] parameters = new SqlParameter[2];
            parameters[0] = new SqlParameter("@First_Id", SqlDbType.Int);
        ...
        public static List<User> GetFriends(int id)
        {
            List<int> targetIds = new List<int>();
            List<User> target = new List<User>();
            SqlCommand cmd = new SqlCommand("SelectFriends", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter parameter = new SqlParameter("@User_Id", SqlDbType.Int);
            parameter.Value = id;
        ...
        public static void SendFriendRequest(int firstId, int secondId)
        {
            SqlCommand cmd = new SqlCommand("CreateFriendRequest", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter[] parameters = new SqlParameter[2];
            parameters[0] = new SqlParameter("@Sender_Id", SqlDbType.Int);
            parameters[0].Value = firstId;
            parameters[1] = new SqlParameter("@Target_Id", SqlDbType.Int);
            parameters[1].Value = secondId;
            cmd.Parameters.AddRange(parameters);
        ...
        public static int GetRequestSenderId(int firstId, int secondId)
        {
            int answer;
            SqlCommand cmd = new SqlCommand("GetRequestSenderId", Conn);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            SqlParameter[] parameters = new SqlParameter[2];
            parameters[0] = new SqlParameter("@First_Id", SqlDbType.Int);
