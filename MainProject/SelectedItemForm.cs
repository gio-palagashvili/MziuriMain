...
namespace MainProject
{
    public partial class UpdatedLabel : UserControl
    {
        ...
        public UpdatedLabel(User user, Item item)
        {
            _currentUser = user;
            _item = item;
            ...
            bool areFriends = BaseInteraction.AreFriends(_currentUser.Id, _itemOwner.Id);
        ...
        {
            _itemAfterCheck = BaseInteraction.GetItemById(_item.Id);
            ...
            if (isNotSame)
            {
                ...
                Program.UpdateItemForm(_currentUser, _itemAfterCheck);
